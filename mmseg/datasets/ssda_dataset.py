...
class UDADataset(object):
    ...
    def get_rare_class_sample(self):
        ...
        return {
            **s1, 'target_img_metas': s2['img_metas'],
            'target_img': s2['img'], 'target_labeled_img': s3['img'], 
            'target_labeled_img_metas': s3['img_metas'], 'target_labeled_gt': s3['gt_semantic_seg']
        }
    ...
    def __len__(self):
        return len(self.source) * len(self.target) * len(self.target_labeled)
